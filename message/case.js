...
const m = dev
var Ownerin ="6285707731622@s.whatsapp.net"
var ownerNumber = [`${nomerOwner}@s.whatsapp.net` ,`${nomerOwner2}@s.whatsapp.net`,`6285707731622@s.whatsapp.net`,`${conn.user.jid}`]
...
conn.sendMessage(from, { id: m.key.id, contextInfo: {   forwardingScore: 10, isForwarded: true, externalAdReply:{showAdAttribution: true, title: `${baileysVersion}`,body:`Runtime ${runtime(process.uptime())} `,previewType:"PHOTO",thumbnail: fs.readFileSync('./stik/reply.jpg')}},showAdAttribution: true, text: teks }, { quoted: dev })
...
'orderMessage': {
'orderId': '6285707731622@s.whatsapp.net',
...
switch(command) {
	...
	if(setmenu == "document"){
	conn.sendButDoc(from, menunya,readmore+fiturnya,null, mok, options1,{quoted: setQuoted})
...
break 
	...
	*JAWABAN KE ${i + 1}*${v.verification ? ' (Verified)' : ''}${v.isBest ? ' (Terpilih)' : ''}
	...
	conn.sendMessage(from, {caption: "Nih", video: {url: ep}},{quoted: dev})
	 })
	 }
	 break
